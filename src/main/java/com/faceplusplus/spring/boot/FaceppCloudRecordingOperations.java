...
import com.faceplusplus.spring.boot.req.RecordingUpdateRtmpPublishConfig;
import com.faceplusplus.spring.boot.req.RecordingUpdateStreamSubscribe;
import com.faceplusplus.spring.boot.req.RecordingUpdateTranscodingConfig;
import com.faceplusplus.spring.boot.req.RecordingUpdateWebConfig;
import com.faceplusplus.spring.boot.req.TranscodingConfig;
import com.faceplusplus.spring.boot.resp.AcquireResourceResponse;
import com.faceplusplus.spring.boot.resp.CloudRecordingQueryResponse;
import com.faceplusplus.spring.boot.resp.CloudRecordingStartResponse;
import com.faceplusplus.spring.boot.resp.CloudRecordingStopResponse;
import com.faceplusplus.spring.boot.resp.CloudRecordingUpdateLayoutResponse;
import com.faceplusplus.spring.boot.resp.CloudRecordingUpdateResponse;
 ...
 */
public class FaceppCloudRecordingOperations extends FaceppOperations {

	protected final static FacesetBo DEFAULT_RECORDING_FILE_CONFIG = new FacesetBo();

	public FaceppCloudRecordingOperations(FaceppTemplate faceppTemplate) {
	...
	public AcquireResourceResponse acquireId(String userId, String uid) throws IOException {
        ...
        String reqUrl = AgoraApiAddress.ACQUIRE_RESOURCE_ID.getUrl(getFaceppProperties().getAppId());
	...
	public CloudRecordingStartResponse startRecording(String channelName, String uid, String token, String resourceId, RecordingMode mode,
        ...
        String reqUrl = AgoraApiAddress.START_CLOUD_RECORDING.getUrl(getFaceppProperties().getAppId(), resourceId, mode.getName());
	...
	public CloudRecordingUpdateResponse updateRecording(String channelName, String uid, String resourceId, String sid, RecordingMode mode,
        ...
        String reqUrl = AgoraApiAddress.UPDATE_CLOUD_RECORDING.getUrl(getFaceppProperties().getAppId(), resourceId, sid, mode.getName());
	...
	public CloudRecordingUpdateLayoutResponse updateLayout(String channelName, String uid, String resourceId, String sid, RecordingMode mode,
        ...
        String reqUrl = AgoraApiAddress.UPDATE_CLOUD_RECORDING_LAYOUT.getUrl(getFaceppProperties().getAppId(), resourceId, sid, mode.getName());
	...
	public CloudRecordingQueryResponse queryRecording(String channelName, String uid, String resourceId, String sid, RecordingMode mode) throws IOException {
        String reqUrl = AgoraApiAddress.QUERY_CLOUD_RECORDING.getUrl(getFaceppProperties().getAppId(), resourceId, sid, mode.getName());
	...
	public CloudRecordingStopResponse stopRecording(String channelName, String uid, String resourceId, String sid, RecordingMode mode, boolean asyncStop) throws IOException {
		...
		String reqUrl = AgoraApiAddress.STOP_CLOUD_RECORDING.getUrl(getFaceppProperties().getAppId(), resourceId, sid, mode.getName());
